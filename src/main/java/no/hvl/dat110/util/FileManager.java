...
public class FileManager {
	...
	public BigInteger getHash() { return hash; }
	public void setHash(BigInteger hash) { this.hash = hash; }
	public byte[] getBytesOfFile() { return bytesOfFile; }
	public void setBytesOfFile(byte[] bytesOfFile) { this.bytesOfFile = bytesOfFile; }
	public String getSizeOfByte() { return sizeOfByte; }
	public void setSizeOfByte(String sizeOfByte) { this.sizeOfByte = sizeOfByte; }
	public NodeInterface getChordnode() { return chordnode; }
	public Set<Message> getActiveNodesforFile() { return activeNodesforFile; }
	public BigInteger[] getReplicafiles() { return replicafiles; }
